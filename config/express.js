...
*/
	...
	//});
	var redirectingTable = require("../app/models/redirectingTable.js");
	var RedirecitngUrl = require('../app/routes/redirectingUrls');
	RedirecitngUrl(config,redirectingTable,app);
